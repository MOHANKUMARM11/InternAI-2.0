...
import { Download, ExternalLink, ChevronDown, MessageCircle } from 'lucide-react'
import CareerTwinModal from '../../components/company/CareerTwinModal'
...
const Applicants = () => {
  ...
  const [activeTwinApp, setActiveTwinApp] = useState(null)
  ...
  return (
    ...
    <div className="max-w-6xl mx-auto p-6">
                  ...
                  <tr key={app._id} className="hover:bg-gray-50">
                    <td className="p-4 font-medium text-gray-900">
                      <div className="flex items-center space-x-2">
                        <span>{app.studentId?.name || 'Unknown'}</span>
                        {app.studentId && (
                          <button 
                            onClick={() => setActiveTwinApp(app)}
                            className="text-indigo-600 hover:text-indigo-800 p-1 bg-indigo-50 rounded"
                            title="Chat with Career Twin"
                          >
      ...
      {activeTwinApp && (
        <CareerTwinModal 
          applicationId={activeTwinApp._id} 
          studentName={activeTwinApp.studentId?.name} 
          onClose={() => setActiveTwinApp(null)} 
        />
      )}
    </>
  )
